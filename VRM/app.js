    ...
    animacion(sphere){
        ...
        if (sphere.position.z > 1 & sphere.position.x > 0.5){ // Servidor
            if (contador == 7 || contador == 18) { // Servidor-Proxy
                ...
                sphereRTP1.position.set (1, 0.3, 1);
                ...
                sphereRTP2.position.set (1, 0.3, 1);
                ...
                sphereRTP3.position.set (1, 0.3, 1);
                ...
                sphereRTP4.position.set (1, 0.3, 1);
                ...
                sphereRTP5.position.set (1, 0.3, 1);
